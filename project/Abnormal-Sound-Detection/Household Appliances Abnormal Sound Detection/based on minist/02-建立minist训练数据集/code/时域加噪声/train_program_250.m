...
% fid=fopen（文件路径，‘打开方式’）
    ...
    % w后添加“b”，则以二进制格式打开
fid_fiture = fopen('..\..\mnist\250\train-images-idx3-ubyte','wb'); %特征
fid_label = fopen('..\..\mnist\250\train-labels-idx1-ubyte','wb'); %标签
...
for i = 1:89
    path_p = ['..\..\洗衣机提取数据\整理数据\TRAIN\正常-1\',num2str(i), '.mat'];
    path_n = ['..\..\洗衣机提取数据\整理数据\TRAIN\异常-0\',num2str(i),'.mat'];
...
gzip('..\..\mnist\250\train-images-idx3-ubyte')
gzip('..\..\mnist\250\train-labels-idx1-ubyte')
disp('finished')
