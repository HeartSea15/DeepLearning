...
% fid=fopen（文件路径，‘打开方式’）
    ...
    % w后添加“b”，则以二进制格式打开
fid_fiture = fopen('..\..\mnist\50\时域加噪声\t10k-images-idx3-ubyte','wb'); %特征
fid_label = fopen('..\..\mnist\50\时域加噪声\t10k-labels-idx1-ubyte','wb'); %标签
...
gzip('..\..\mnist\50\时域加噪声\t10k-images-idx3-ubyte')
gzip('..\..\mnist\50\时域加噪声\t10k-labels-idx1-ubyte')
disp('finished')
